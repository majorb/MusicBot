...
public class JMusicBot 
{
    ...
    public static void main(String[] args)
    {
        ...
        AboutCommand aboutCommand = new AboutCommand(Color.BLUE.brighter(),
                                "a music bot that is [easy to host yourself!](https://github.com/majorb/MusicBot) (v"+version+")",
                                new String[]{"High-quality music playback", "SimpleQueue™ Technology", "Easy to host yourself"},
                                RECOMMENDED_PERMS);
